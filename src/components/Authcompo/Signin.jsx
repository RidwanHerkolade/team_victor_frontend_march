...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-white px-8 md:px-14 py-7 max-w-4xl mx-auto">
      ...
      <h1 className="text-xl md:text-2xl font-bold text-[#5B21B6] mb-10">
        Login
      </h1>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-5">
        ...
        <div className="flex justify-end mt-2">
          <button
            type="submit"
            disabled={isPending}
            className={`bg-[#8533cd] text-white font-bold text-lg px-12 py-3 rounded-lg w-full md:w-auto md:min-w-[320px] tracking-wide shadow-[0_4px_20px_rgba(109,40,217,0.25)] transition-all
    ${!isPending && "hover:bg-[#5B21B6] hover:rounded-tl-full hover:rounded-br-full cursor-pointer"}
